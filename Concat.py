...
def predict_rating(year, genre_sentiment, is_weekend, is_holiday_release, is_peak_season, season_features, director_avg_rating, genre_avg_rating, movies_per_year):
    features = [year, genre_sentiment, is_weekend, is_holiday_release, is_peak_season] + season_features + [director_avg_rating, genre_avg_rating, movies_per_year]
...
predicted_rating = predict_rating(2024, 0.5, 1, 0, 1, season_features, 7.0, 6.5, 50)
print(f'Predicted Rating for a movie in 2024 with genre sentiment 0.5, director average rating 7.0, genre average rating 6.5, and 50 movies released in the year: {predicted_rating:.2f}')
